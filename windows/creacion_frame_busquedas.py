...
class FrameBusqueda(tk.Frame):
    ...
    def campos_busquedas(self):
       #busqueda nombre 
        ...
        self.label_busqueda_nombre.grid(row=11,column=1,pady=10)
        ...
        self.entry_busqueda_nombre.grid(row=11,column=2,pady=10,columnspan=2)
        ...
        self.label_mensaje_busqueda_b.grid(row=13,column=0)
