...
class FrameCuentaNueva(FrameBusqueda):
    ...
    def campos_cuenta_nueva(self):
        ...
        self.label_domicilio.grid(row=3,column=0,padx=10,pady=10)


        self.label_domicilio_trabajo=tk.Label(self,text='Domicilio Trabajo')
        self.label_domicilio_trabajo.config(font=('Arial',12,'bold'))
        self.label_domicilio_trabajo.grid(row=4,column=0,padx=10,pady=10)

        self.label_domicilio_funcion=tk.Label(self,text='Puesto')
        self.label_domicilio_funcion.config(font=('Arial',12,'bold'))
        self.label_domicilio_funcion.grid(row=5,column=0,padx=10,pady=10)
        ...
        self.entry_domicilio_trabajo.grid(row=4,column=1,padx=10,pady=10,columnspan=2)
        ...
        self.entry_funcion.grid(row=5,column=1,padx=10,pady=10,columnspan=2)
    ...
    def  guradar_datos_cuenta_nueva(self,event):
        ...
        domicilio_trabajo=self.mi_domicilio_trabajo.get()
            ...
            if dni:
                try:
                    ...
                    if dni_vericado==None:
                            ...
                            if domicilio_trabajo=="":
                                 domicilio_trabajo=="no lo tenemos"
                            if funcion=="":
                            ...
                            mensaje= f"el usuario {nombre} dni {dni} se cargo de manera exitosa, su numero de cuenta es {cuenta_numero}" 
