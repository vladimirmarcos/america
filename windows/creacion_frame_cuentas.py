...
class FrameCuentaNueva(FrameBusqueda):
    ...
    def campos_cuenta_nueva(self):
        ...
        self.label_nombre.grid(row=1,column=0,pady=10)

        self.label_dni=tk.Label(self,text='DNI (obligatorio)',justify=tk.LEFT)
        self.label_dni.config(font=('Arial',12,'bold'))
        self.label_dni.grid(row=2,column=0,pady=10)

        self.label_telefono=tk.Label(self,text='Teléfono',justify=tk.LEFT)
        self.label_telefono.config(font=('Arial',12,'bold'))
        self.label_telefono.grid(row=3,column=0,pady=10)

        self.label_domicilio=tk.Label(self,text='Domicilio',justify=tk.LEFT)
        self.label_domicilio.config(font=('Arial',12,'bold'))
        self.label_domicilio.grid(row=4,column=0,pady=10)


        self.label_domicilio_trabajo=tk.Label(self,text='Domicilio Trabajo',justify=tk.LEFT)
        self.label_domicilio_trabajo.config(font=('Arial',12,'bold'))
        self.label_domicilio_trabajo.grid(row=5,column=0,pady=10)

        self.label_funcion=tk.Label(self,text='Puesto',justify=tk.LEFT)
        self.label_funcion.config(font=('Arial',12,'bold'))
        self.label_funcion.grid(row=6,column=0,pady=10)

        self.label_mensaje_opciones_h=tk.Label(self,text='Presione h o H en  opciones para habilitar campos de cuenta nueva',justify=tk.LEFT)
        self.label_mensaje_opciones_h.config(font=('Arial',12,'bold'))
        self.label_mensaje_opciones_h.grid(row=11,column=0)

        self.label_mensaje_errores=tk.Label(self,text='Nombre y dni no pueden estar vacios, Dni no puede estar registrado',justify=tk.LEFT)
        ...
        self.entry_domicilio.grid(row=4,column=1,pady=10,columnspan=2)

        self.mi_domiciliotrabajo=tk.StringVar()
        self.entry_domicilio_trabajo=tk.Entry(self,textvariable=self.mi_domiciliotrabajo)
        self.entry_domicilio_trabajo.config(width=50,font=('Arial',12))
        self.entry_domicilio_trabajo.grid(row=5,column=1,pady=10,columnspan=2)
    ...
    def  guradar_datos_cuenta_nueva(self,event):
        ...
        domiciliotrabajo=self.mi_domiciliotrabajo.get()
        
        funcion=self.mi_funcion.get()
        if nombre!="" and dni!="":
            ...
            if dni:
                try:
                    ...
                    if dni_vericado==None:
                            ...
                            titulo=f"Generación de nueva cuenta"
                            mensaje=f"Generación de nueva cuenta de cliente con nombre {Cuenta_Nueva.nombre}, con dni {Cuenta_Nueva.dni}, con domicilio en {Cuenta_Nueva.domicilio}, con telefono {Cuenta_Nueva.telefono}, con domicilio de trabajo es {Cuenta_Nueva.domiciliotrabajo} cuya función es {Cuenta_Nueva.funcion}"
                            ...
                            if respuesta:
                                ...
                                mensaje= f"el usuario {nombre} dni {dni} se cargo de manera exitosa, su numero de cuenta es {Cuenta_Nueva.numero_cuenta}" 
...
class FrameModificarCuenta(FrameBusqueda):
    ...
    def campos_nuevos_cuenta(self):
        ...
        self.label_domicilio_trabajo=tk.Label(self,text='Domicilio Trabajo')
        self.label_domicilio_trabajo.config(font=('Arial',12,'bold'))
        self.label_domicilio_trabajo.grid(row=5,column=0,padx=10,pady=10)

        self.label_funcion=tk.Label(self,text='Puesto')
        self.label_funcion.config(font=('Arial',12,'bold'))
        self.label_funcion.grid(row=6,column=0,padx=10,pady=10)
        ...
        self.mi_domicilio_trabajo=tk.StringVar()
        self.entry_domicilio_trabajo=tk.Entry(self,textvariable=self.mi_domicilio_trabajo)
        self.entry_domicilio_trabajo.config(width=50,font=('Arial',12))
        self.entry_domicilio_trabajo.grid(row=5,column=1,padx=10,pady=10,columnspan=2)

        self.mi_funcion=tk.StringVar()
        self.entry_funcion=tk.Entry(self,textvariable=self.mi_funcion)
        self.entry_funcion.config(width=50,font=('Arial',12))
        self.entry_funcion.grid(row=6,column=1,padx=10,pady=10,columnspan=2)
    ...
    def verifica_tecla(self,event):
         ...
         super().verifica_tecla(event)
         if self.variable=='M' or self.variable=='m':
              self.habilitar_campos_nuevos_cuenta()
